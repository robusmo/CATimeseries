...
Dygraph.numDateTicks = function(start_time, end_time, granularity) {
  if (granularity < Dygraph.MONTHLY) {
    ...
    if (granularity == Dygraph.ANNUAL3) { num_months = 1; year_mod = 3; }
    if (granularity == Dygraph.ANNUAL5) { num_months = 1; year_mod = 5; }
	if (granularity == Dygraph.ANNUAL10) { num_months = 1; year_mod = 10; }	
	if (granularity == Dygraph.ANNUAL20) { num_months = 1; year_mod = 20; }	
...
Dygraph.getDateAxis = function(start_time, end_time, granularity, opts, dg) {
  ...
  if (granularity < Dygraph.MONTHLY) {
    ...
    if (granularity == Dygraph.MONTHLY) {
      ...
      months = [ 0 ];
    } else if (granularity == Dygraph.ANNUAL3) {
      months = [ 0 ];
      year_mod = 3;
    } else if (granularity == Dygraph.ANNUAL5) {
      months = [ 0 ];
      year_mod = 5;
    } else if (granularity == Dygraph.ANNUAL10) {
      months = [ 0 ];
      year_mod = 10;
    } else if (granularity == Dygraph.ANNUAL20) {
      months = [ 0 ];
      year_mod = 20;
    } else {
	alert("Span of dates is too long");
